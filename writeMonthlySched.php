<HTML>
  <HEAD>
    ...
    <?php 
      ...
      $_SERVER['SERVER_NAME'].'/pp-homecheck/editMonthlySchedule.php?Month='.$_POST['Month'].'&Year='.$_POST['Year'].'"/>');
    ?>
  </HEAD>
  <BODY>
    <p>Saving Monthly Schedule</p>
    <?php 
      echo('<a href="http://'.$_SERVER['SERVER_NAME'].'/pp-homecheck/editMonthlySchedule.php?Month='.$_POST['Month'].'&Year='.$_POST['Year'].'">Click here if you are not redirected back to the monthly schedule.</a>');

<?php
	...
	if ($_POST[Time1] !== null && $_POST[Time2] !== null && $_POST[Participant] !== null){
	...
	if($dl == null){
		if($_POST[Participant] != null || $_POST[dNotes] != null) insert_dbDailyLogs(new DailyLog($_POST[Date],$_POST[Participant],$_POST[Volunteer],$_POST[dNotes]));
	}
	else{
		...
		if($eid != null) {
			if($_POST[Participant] != null) {
				...
				foreach($eid as &$parts) $participants .= $parts.",";
			}
		}
		else $participants = $_POST[Participant];
		if($_POST[dNotes] == null) $dNotes = $dl->get_note();
		else $dNotes = $_POST[dNotes];
